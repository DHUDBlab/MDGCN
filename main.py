...
class Hope:
    ...
    def _train(self):
        ...
        for i, tem in enumerate(self.train_loader):
            ...
            # GET Embedding
            drugEmbed, disEmbed, rd_drugEmbedAll, rd_disEmbedAll, rd_drugEmbed, rd_disEmbed, meta_reg_loss = self.model(
            ...
            # Common loss to enhance common part of Grr with Grd and Gd with Grd
            ...
            loss = bce_loss + ssl_loss_all * args.ssl_beta + meta_reg_loss * args.metareg #+ common_loss_all * args.com_beta  # + regLoss * args.reg
            self.opt.zero_grad()
            loss.backward()
...
if __name__ == '__main__':
    ...
    for time in range(1, 2):
        print(
            f"{Colors.RED}++++++++++++++++++++++ {str(time)} time START +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++{Colors.RESET}")
        time_results = {'ep': [], 'auroc': [], 'aupr': []}
        for fold in range(5, 6):
            print(
                f"{Colors.YELLOW}======================== {str(fold)} fold start ============================================={Colors.RESET}")
            data = dataHandler.data[0][fold - 1] # [trainMat, testMat, heretoMat]
