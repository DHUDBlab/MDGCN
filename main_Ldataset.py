...
def make_args():
    ...
    parser.add_argument('--dataset', type=str, default='Ldataset')
    ...
    parser.add_argument('--epochs', type=int, default=18, metavar='N', help='number of epochs to train')
    ...
    parser.add_argument('--layers', type=int, default=13+3, help='the numbers of GCN layer')
    ...
    parser.add_argument('--ssl_reg_r', type=float, default=0.064)  # drug reg
    parser.add_argument('--ssl_reg_d', type=float, default=0.085)  # disease reg

    parser.add_argument('--wr1', type=float, default=0.5, help='the coefficient of feature fusion ')
    parser.add_argument('--wr2', type=float, default=0.5, help='the coefficient of feature fusion')
    parser.add_argument('--wd1', type=float, default=0.5, help='the coefficient of feature fusion ')
    parser.add_argument('--wd2', type=float, default=0.5, help='the coefficient of feature fusion')

    parser.add_argument('--metareg', type=float, default=0.16, help='weight of loss with reg')
    parser.add_argument('--ssl_temp', type=float, default=0.5, help='the temperature in softmax')
    parser.add_argument('--new1', type=float, default=0.25, help='parser_1')
