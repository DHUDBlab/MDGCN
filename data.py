...
_paths = {
    ...
    'DB-KEGG': script_dir + '/data/DB-KEGG',
}
...
class DataHandler(object):
    ...
    def load_data(self, file_path, data_name):
        ...
        elif data_name in ['DB-KEGG']:
            # association_matrix = np.loadtxt(os.path.join(file_path, 'drug_dis.csv.gz'), delimiter=",")
            # self.dis_sim_features = np.loadtxt(os.path.join(file_path, 'dis_sim_jaccard.csv.gz'), delimiter=",")
            # self.drug_sim_features = np.loadtxt(os.path.join(file_path, 'drug_sim.csv.gz'), delimiter=",")

            association_matrix = np.load(os.path.join(file_path, 'drug_dis.npy'))
            self.dis_sim_features = np.load(os.path.join(file_path, 'dis_sim_jaccard.npy'))
            self.drug_sim_features = np.load(os.path.join(file_path, 'drug_sim.npy'))
